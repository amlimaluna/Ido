<%-- 
    Document   : index
    Created on : 03/11/2019, 22:59:37
    Author     : amaaa
--%>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>I do - Uma nova abordagem de marketing</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
          <a class="navbar-brand" href="index.jsp"><img style="width: 150px;" src="images/idobranco.png"> </a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href=#funciona class="nav-link">Com funciona</a></li>   
        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 ftco-animate text-center">
              <h1 class="mb-4">I do
                <strong class="typewrite" data-period="1000" data-type='[ "busca confiável.", "indicação certeira.", "sua marca em destaque.", "Marketing!" ]'>
                  <span class="wrap"></span>
                </strong>
              </h1>
              <p>Uma abordagem diferente de tudo que você já viu para recomendação de Marketing Digital em perfis no Instagram.</p>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span id="sobre" class="subheading">Sobre</span>
            <h2>O que é o "I do"?</h2>
          </div>
        </div>
        <div class="row">
